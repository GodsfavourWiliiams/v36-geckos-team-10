...
const Contact = () => {
  return (
    <div className='relative'>
        <div className="flex flex-col items-center md:flex-row justify-between max-w-screen-xl px-3 md:px-8 mx-auto md:py-24">
            <div className="md:w-5/12 flex-shrink-0 h-80 md:h-auto">
                <img src={EmailIllustrationSrc} alt="" className="" />
            </div>
