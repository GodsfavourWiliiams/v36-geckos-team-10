       ...
       <div className="w-full flex items-center justify-between py-5">
           ...
           <hr className="w-full bg-gray-400  " />
            ...
            <form >
                ...
                required/>
                <div className="relative passwordToggle"
                ...
                <button className="bg-indigo-600 border border-transparent rounded-lg py-3 px-8 mb-3 text-base font-medium text-white hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 w-full"
                 onClick={(e) => {
                     logInWithEmailAndPassword(email, password);
                     e.preventDefault()
                     }}>Sign In</button>
                     
                     <Link to='/reset' className="text-indigo-500">
